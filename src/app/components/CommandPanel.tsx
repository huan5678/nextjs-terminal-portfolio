...
const KeyButton = ({ label, active }) => (
    <div className={`w-12 h-12 flex items-center justify-center border-2 border-green-500 text-white font-bold text-xl
        ${active ? 'bg-green-500 text-black' : 'bg-black'}
...
export default function CommandPanel({ onKonamiCode, onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-gray-900 p-8 rounded-none shadow-lg border-2 border-green-500 text-lg">
